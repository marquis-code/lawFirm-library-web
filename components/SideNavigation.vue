              ...
              <ul role="list" class="flex flex-1 flex-col gap-y-7">
                <li>
                  <ul role="list" class="-mx-2 space-y-1">
                    ...
                    <li>
                      <a :class="[router?.currentRoute?.fullPath === '/#service-providers' ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800']" href="#agents" @click="handleClick" class="group flex gap-x-3 rounded-md p-2 py-3 text-sm/6 font-semibold">
                        <img src="@/assets/icons/user-type.svg" />
                        Service Providers
                      </a>
                    </li>
                    <li>
                      <a :class="[router?.currentRout?.fullPath === '/#about-us' ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800']" href="#about-us" @click="handleClick" class="group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold">
                ...
                <div class="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-[#292929] px-6 pb-4 ring-1 ring-white/10">
                        ...
                        <nav class="flex flex-1 flex-col">
                            ...
                            <button @click="toggleDropdown" class="bg-[#326543] w-full text-white px-6 py-3 rounded-md  focus:outline-none">
                                Login
                            </button>
                            <div v-if="isDropdownOpen" class="absolute left-0 mt-14 w-60 space-y-5 py-4 bg-white shadow-xl rounded-xl overflow-hidden">
                                ...
                                <div @click="handleRedirect" class="block px-4 cursor-pointer py-2 pb-4 text-[#1D2739] border-b-[0.5px] border-gray-100 font-semibold flex justify-between items-center">
                                    <div class="flex items-center gap-x-2 text-sm">
                                        <img src="@/assets/icons/user-type.svg" />
                                        <span>Agent</span>
                                    </div>
