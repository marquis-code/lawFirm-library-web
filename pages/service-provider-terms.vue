<template>
    <main class="mt-24 container mx-auto">
      <div v-if="!loading && Object.keys(termsList || {})?.length" class="">
  ...
  import { useFetchTermsOfUse } from "@/composables/modules/settings/useFetchServiceProviderTermsOfUse";
