<template>
    <main  class="max-w-7xl  mx-auto">
     <div  v-if="!loading && Object.keys(policiesList)?.length" class="mt-20 bg-gray-25 min-h-screen">
       <div>
         <!-- <svg
               @click="router.back()"
     ...
     <section v-else-if="loading && !Object.keys(policiesList)?.length">
         <div class="rounded-md p-4 mt-32 max-w-4xl mx-auto mx-auto">
       ...
       <section v-else class="flex flex-col justify-between mt-32 items-center space-y-2 mt-10">
